...
import { buildLoginRequest, buildMsalConfig } from "../lib/auth/msal-client";
    ...
    const init = async () => {
      try {
        ...
        if (!clientId || !tenantId) {
          throw new Error(
            "Azure AD environment variables are not set. Please configure VITE_AZURE_AD_CLIENT_ID and VITE_AZURE_AD_TENANT_ID."
          );
        }
